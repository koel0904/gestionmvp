          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-white/10">
                ...
                <th className="py-4 px-4 text-xs font-bold text-white/50 uppercase tracking-wider hidden xl:table-cell">
                  Frecuencia
                </th>
            ...
            <tbody>
              {vehiculos.map((v) => (
                ...
                >
                  ...
                  {/* Frecuencia */}
                  <td className="py-4 px-4 align-middle hidden xl:table-cell">
                    {v.frecuenciaTiempo || v.frecuenciaKm ? (
                      <div>
                        {v.frecuenciaTiempo && (
                          <div className="text-sm text-white/70">
                            {v.frecuenciaTiempo}
                        ...
                        {v.frecuenciaKm && (
                          <div className="text-xs text-white/40">
                            {v.frecuenciaKm.toLocaleString()} km
                          </div>
                        )}
                      </div>
                    ) : (
