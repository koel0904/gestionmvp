    ...
    return (
        ...
        >
            <div className="relative">
                ...
                {selectorOpen && (
                    <div
                        className={`absolute top-full mt-2 z-[100] rounded-xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 ${sidebarOpen ? "left-0 right-0" : "left-0 w-[220px]"
                            }`}
                        style={{
